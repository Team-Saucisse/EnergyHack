...
namespace TheSaucisseFactory.BOM.Windows8.[%=entity.Name%]Proxy
{
    ...
    public partial class [%=entity.Name%]ServiceClient
    {
        ...
        /// <summary>
        /// Wrap l'appel à LoadAll[%=l_loadSuffix%]Async en passant le header standard.
        /// </summary>
        /// <returns>Résultat de la méthode wrappée</returns>
        public static Task<[%=entity.Name%]Collection> CallLoadAll[%=l_loadSuffix%]Async()
        {
            ...
            using (var l_scope = new System.ServiceModel.OperationContextScope(l_serviceClient.InnerChannel))
            {
                ...
                return l_serviceClient.LoadAll[%=l_loadSuffix%]Async();
            }
        }

        /// <summary>
        /// Wrap l'appel à LoadById[%=l_loadSuffix%]Async en passant le header standard.
        /// </summary>
        /// <param name="p_id">Id de [%=entity.Name%]</param>
        /// <returns>Résultat de la méthode wrappée</returns>
        public static Task<[%=entity.Name%]> CallLoadById[%=l_loadSuffix%]Async(Guid p_id)
        {
            [%=entity.Name%]ServiceClient l_serviceClient = new [%=entity.Name%]ServiceClient();
            ...
            {
                ServiceClientSettings.TheSaucisseFactory.AddCommonHeader();
                return l_serviceClient.LoadById[%=l_loadSuffix%]Async(p_id);
            }
        }
