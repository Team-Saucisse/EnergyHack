...
<html>
    ...
    void Page_Load(object sender, EventArgs e) {
        ...
        foreach(DictionaryEntry de in methodsTable)
        {
	        methodsList.Add(de);
        }
        methodsList.Sort(new MethodComparer());

        MethodList.DataSource = methodsList;
    ...
    class MethodComparer: IComparer
    {
		int IComparer.Compare(object o1, object o2)
		{			
			return ((DictionaryEntry)o1).Key.ToString().CompareTo(((DictionaryEntry)o2).Key.ToString());
		}
    }
  ...
  <head>
    ...
    <style type="text/css">
		...
		h2 { <%#GetLocalizedText("Styleh2")%>;color:orange;}
