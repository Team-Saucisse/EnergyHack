...
namespace TheSaucisseFactory.Resources
{
    ...
    public sealed partial class Manager
    {
        ...
        private Manager()
        {
            this._resources = new System.Resources.ResourceManager("TheSaucisseFactory.TheSaucisseFactory", System.Reflection.Assembly.GetExecutingAssembly());
            try
            {
    ...
    public sealed partial class ValueValidationFailureHandler : CodeFluent.Runtime.Rules.BaseValueValidationFailureHandler
    {
        ...
        private static TheSaucisseFactory.Resources.ValueValidationFailureHandler _current = new TheSaucisseFactory.Resources.ValueValidationFailureHandler();
        
        public ValueValidationFailureHandler()
        {
        }
        
        public static TheSaucisseFactory.Resources.ValueValidationFailureHandler Current
        {
            get
            {
                return TheSaucisseFactory.Resources.ValueValidationFailureHandler._current;
            }
        }
        ...
        public override string GetMessage(System.Globalization.CultureInfo culture, CodeFluent.Runtime.Rules.ValueValidator validator, string failureCode, object[] arguments)
        {
            ...
            string message = TheSaucisseFactory.Resources.Manager.GetString(culture, code, arguments);
            if ((message == code))
            {
                return baseMessage;
            }
...
namespace TheSaucisseFactory
{
    ...
    public sealed partial class Constants
    {
        ...
        public const string TheSaucisseFactoryStoreName = "TheSaucisseFactory";
