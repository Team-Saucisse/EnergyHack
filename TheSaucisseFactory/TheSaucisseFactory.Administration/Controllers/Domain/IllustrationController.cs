...
{
    public partial class IllustrationController : Controller
    {
        public virtual ActionResult Index(string currentFilter, string searchString, int? page)
        {
			...
			IEnumerable<TheSaucisseFactory.Illustration> l_items = TheSaucisseFactory.IllustrationCollection.PageLoadAll(int.MinValue, int.MaxValue, l_pageOptions);
            ...
            return View("Illustration/Index", l_items.ToPagedList(pageNumber, pageSize));
        }

        public virtual ActionResult Details(string entityKey)
        {
            TheSaucisseFactory.Illustration entity = TheSaucisseFactory.Illustration.LoadByEntityKey(entityKey);
            if (entity == null)
			{
	            return new EmptyResult();
			}
				
            return View("Illustration/Details", entity);
        }
        ...
        public virtual ActionResult Create()
        {
            ...
            TheSaucisseFactory.Illustration entity = new TheSaucisseFactory.Illustration();
            return View("Illustration/Create", entity);
        }
		
		[HttpPost]
        public virtual ActionResult Create(TheSaucisseFactory.Illustration entity)
        {
            if (entity == null)
			{
        ...
        public virtual ActionResult Edit(string entityKey)
        {
            ...
            return View("Illustration/Edit", entity);
        }
		
		[HttpPost]
        public virtual ActionResult Edit(string entityKey, TheSaucisseFactory.Illustration entity)
        {
            if (entity == null)
			{
                throw new ArgumentNullException("entity");
        ...
        {
            EntityDescriptor ed = ProjectDescriptor.Current.GetEntityDescriptor(typeof(TheSaucisseFactory.Illustration), true);
            try
            {
