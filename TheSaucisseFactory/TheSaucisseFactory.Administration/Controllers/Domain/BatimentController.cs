...
{
    public partial class BatimentController : Controller
    {
        public virtual ActionResult Index(string currentFilter, string searchString, int? page)
        {
			...
			IEnumerable<TheSaucisseFactory.Batiment> l_items = TheSaucisseFactory.BatimentCollection.PageLoadAll(int.MinValue, int.MaxValue, l_pageOptions);
            ...
            return View("Batiment/Index", l_items.ToPagedList(pageNumber, pageSize));
        }

        public virtual ActionResult Details(string entityKey)
        {
            TheSaucisseFactory.Batiment entity = TheSaucisseFactory.Batiment.LoadByEntityKey(entityKey);
            if (entity == null)
			{
	            return new EmptyResult();
			}
				
            return View("Batiment/Details", entity);
        }
        ...
        public virtual ActionResult Create()
        {
            ...
            TheSaucisseFactory.Batiment entity = new TheSaucisseFactory.Batiment();
            return View("Batiment/Create", entity);
        }
		
		[HttpPost]
        public virtual ActionResult Create(TheSaucisseFactory.Batiment entity)
        {
            if (entity == null)
			{
        ...
        public virtual ActionResult Edit(string entityKey)
        {
            ...
            return View("Batiment/Edit", entity);
        }
		
		[HttpPost]
        public virtual ActionResult Edit(string entityKey, TheSaucisseFactory.Batiment entity)
        {
            if (entity == null)
			{
                throw new ArgumentNullException("entity");
        ...
        {
            EntityDescriptor ed = ProjectDescriptor.Current.GetEntityDescriptor(typeof(TheSaucisseFactory.Batiment), true);
            try
            {
