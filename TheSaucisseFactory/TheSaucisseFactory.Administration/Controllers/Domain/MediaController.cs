...
namespace TheSaucisseFactory.Web
{
    public partial class MediaController : Controller
    {
        ...
        public virtual ActionResult Details(string entityKey)
        {
            ...
            return View("Media/Details", entity);
        }
        ...
        public virtual ActionResult Create()
        {
            ...
            TheSaucisseFactory.Media entity = new TheSaucisseFactory.Media();
            return View("Media/Create", entity);
        }
		
		[HttpPost]
        public virtual ActionResult Create(TheSaucisseFactory.Media entity)
        {
            if (entity == null)
			{
        ...
        public virtual ActionResult Edit(string entityKey)
        {
            ...
            return View("Media/Edit", entity);
        }
		
		[HttpPost]
        public virtual ActionResult Edit(string entityKey, TheSaucisseFactory.Media entity)
        {
            if (entity == null)
			{
                throw new ArgumentNullException("entity");
        ...
        {
            EntityDescriptor ed = ProjectDescriptor.Current.GetEntityDescriptor(typeof(TheSaucisseFactory.Media), true);
            try
            {
