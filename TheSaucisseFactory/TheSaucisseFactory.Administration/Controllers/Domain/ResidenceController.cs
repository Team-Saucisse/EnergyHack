...
{
    public partial class ResidenceController : Controller
    {
        public virtual ActionResult Index(string currentFilter, string searchString, int? page)
        {
			...
			IEnumerable<TheSaucisseFactory.Residence> l_items = TheSaucisseFactory.ResidenceCollection.PageLoadAll(int.MinValue, int.MaxValue, l_pageOptions);
            ...
            return View("Residence/Index", l_items.ToPagedList(pageNumber, pageSize));
        }

        public virtual ActionResult Details(string entityKey)
        {
            TheSaucisseFactory.Residence entity = TheSaucisseFactory.Residence.LoadByEntityKey(entityKey);
            if (entity == null)
			{
	            return new EmptyResult();
			}
				
            return View("Residence/Details", entity);
        }
        ...
        public virtual ActionResult Create()
        {
            ...
            TheSaucisseFactory.Residence entity = new TheSaucisseFactory.Residence();
            return View("Residence/Create", entity);
        }
		
		[HttpPost]
        public virtual ActionResult Create(TheSaucisseFactory.Residence entity)
        {
            if (entity == null)
			{
        ...
        public virtual ActionResult Edit(string entityKey)
        {
            ...
            return View("Residence/Edit", entity);
        }
		
		[HttpPost]
        public virtual ActionResult Edit(string entityKey, TheSaucisseFactory.Residence entity)
        {
            if (entity == null)
			{
                throw new ArgumentNullException("entity");
        ...
        {
            EntityDescriptor ed = ProjectDescriptor.Current.GetEntityDescriptor(typeof(TheSaucisseFactory.Residence), true);
            try
            {
