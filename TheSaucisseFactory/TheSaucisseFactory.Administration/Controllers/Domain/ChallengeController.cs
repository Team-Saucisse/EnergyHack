...
{
    public partial class ChallengeController : Controller
    {
        public virtual ActionResult Index(string currentFilter, string searchString, int? page)
        {
			...
			IEnumerable<TheSaucisseFactory.Challenge> l_items = TheSaucisseFactory.ChallengeCollection.PageLoadAll(int.MinValue, int.MaxValue, l_pageOptions);
            ...
            return View("Challenge/Index", l_items.ToPagedList(pageNumber, pageSize));
        }

        public virtual ActionResult Details(string entityKey)
        {
            TheSaucisseFactory.Challenge entity = TheSaucisseFactory.Challenge.LoadByEntityKey(entityKey);
            if (entity == null)
			{
	            return new EmptyResult();
			}
				
            return View("Challenge/Details", entity);
        }
        ...
        public virtual ActionResult Create()
        {
            ...
            TheSaucisseFactory.Challenge entity = new TheSaucisseFactory.Challenge();
            return View("Challenge/Create", entity);
        }
		
		[HttpPost]
        public virtual ActionResult Create(TheSaucisseFactory.Challenge entity)
        {
            if (entity == null)
			{
        ...
        public virtual ActionResult Edit(string entityKey)
        {
            ...
            return View("Challenge/Edit", entity);
        }
		
		[HttpPost]
        public virtual ActionResult Edit(string entityKey, TheSaucisseFactory.Challenge entity)
        {
            if (entity == null)
			{
                throw new ArgumentNullException("entity");
        ...
        {
            EntityDescriptor ed = ProjectDescriptor.Current.GetEntityDescriptor(typeof(TheSaucisseFactory.Challenge), true);
            try
            {
