...
(function ($, window) {
    ...
    $.jCarousel.plugin('jcarousel', {
        ...
        hasNext: function () {
            ...
            return end >= 0 && ((wrap && wrap !== 'first') || (this.index(this._last) < end) || (this.tail && !this.inTail)) ? true : false;
        },
        hasPrev: function () {
            ...
            return this.items().length > 0 && ((wrap && wrap !== 'last') || (this.index(this._first) > 0) || (this.tail && this.inTail)) ? true : false;
        },
        clipping: function () {
